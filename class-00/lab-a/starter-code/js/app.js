...
function displayPics(){
  ...
  // TODO: DONE. In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `let`.
  // The consoloe.log(rando) threw an error because the variable rando, when assigned with 'let', is a locally scoped variable within the while loop of the function displayPics() and cannot be called outside of the function. This does not occur with console.log(viewed) becuase it is assigned with 'let' in the gloabl scope.
  console.log(viewed);
