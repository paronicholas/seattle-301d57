...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('joe.scope():',joe.scope());
...
// 'this' refers to the Student object created on line 149. It expresses the constructor and the assigned values.
// 2. What is "this" when joe.scopeArrow() is invoked?
// 'this' refers to the Window object (specifically the whole document), and displays all of the functions associated with the Window object.
// 3. Explain why "this" is different when an arrow function is used.
// This acts differently when an arrow function is used because it does not inherently bind its own 'this'.
